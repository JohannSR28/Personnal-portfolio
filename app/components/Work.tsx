...
const staticProjectsData: StaticProject[] = [
  ...
  },
  {
    ...
    liveLink: "https://www.tactorelia.com/",
    codeLink: null,
  },
  {
    id: "cafesansfil",
...
const ProjectItem = ({
  ...
  const showLive = !!project.liveLink && project.liveLink.startsWith("http");
  const showCode = !!project.codeLink && project.codeLink.startsWith("http");
